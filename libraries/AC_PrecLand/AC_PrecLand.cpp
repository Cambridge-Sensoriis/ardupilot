...
const AP_Param::GroupInfo AC_PrecLand::var_info[] = {
    ...
    // @Param: XY_NSE_BASE
    // @DisplayName: Kalman Filter Base XY Position Noise
    // @Description: Kalman Filter Minimum lateral position noise. Sets the minimum XY noise for low altitude
    // @Units: m
    // @Range: 0.0001 0.5
    // @User: Advanced
    ...
    // @Param: XY_NSE_GRAD
    // @DisplayName: Kalman Filter XY Position Noise Gradient
